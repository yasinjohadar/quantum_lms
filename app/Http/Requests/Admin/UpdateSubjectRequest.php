...
class UpdateSubjectRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'حقل اسم المادة مطلوب.',
            'name.max' => 'يجب ألا يزيد طول اسم المادة عن 255 حرفاً.',
            'slug.unique' => 'هذا الرابط الدائم مستخدم من قبل، يرجى اختيار رابط آخر.',
            'class_id.required' => 'يجب اختيار الصف الذي تتبع له المادة.',
            'class_id.exists' => 'الصف المختار غير صحيح.',
