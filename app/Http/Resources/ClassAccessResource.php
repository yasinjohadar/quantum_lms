...
class ClassAccessResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        if ($this->resource instanceof \App\DataTransferObjects\ClassAccessData) {
        ...
        return [
            ...
            'slug' => $this->slug,
            'image' => $this->image,
            'pricing_mode' => $this->is_free ? 'free' : 'paid',
            ...
            'subjects_count' => $this->whenLoaded('subjects', fn () => $this->subjects->count()),
            'subjects' => SubjectAccessResource::collection($this->whenLoaded('subjects')),
        ];
    }
}
