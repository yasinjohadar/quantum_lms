                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                        <a href="{{ route('admin.classes.index') }}" class="card border shadow-sm h-100 text-decoration-none quick-link-card">
                                            <div class="card-body text-center p-3">
                                                ...
                                                <small class="text-muted d-block mt-1">عرض الصفوف المرتبطة بك كمعلم</small>
