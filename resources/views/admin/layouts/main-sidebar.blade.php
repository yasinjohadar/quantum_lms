                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide slide-icon slide-icon--violet has-sub {{ request()->is('users*') || request()->is('admin/users-management*') || request()->is('admin/admins*') || request()->is('admin/archived-users*') || request()->is('admin/teachers/assignments*') || request()->is('admin/supervisors/assignments*') || request()->is('roles*') ? 'open' : '' }}">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                @endcan
                                @can('user-list')
                                <li class="slide {{ request()->is('admin/admins*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.admins.index') }}" class="side-menu__item {{ request()->is('admin/admins*') ? 'active' : '' }}">
                                        <span class="side-menu__label">كافة المدراء</span>
                                    </a>
                                </li>
                                @endcan
                        ...
                        <li class="slide slide-icon slide-icon--cyan has-sub {{ request()->is('admin/classes*') || request()->is('admin/subjects*') || request()->routeIs('admin.lessons.index') || request()->is('admin/lessons*') || request()->is('admin/library*') ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label">المحتوى الدراسي</span>
                                <i class="fe fe-chevron-right side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide side-menu__label1">
                                    <a href="javascript:void(0);">المحتوى الدراسي</a>
                                </li>
                                @can('class-list')
                                <li class="slide {{ request()->is('admin/classes*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.classes.index') }}" class="side-menu__item {{ request()->is('admin/classes*') ? 'active' : '' }}">
                        ...
                        <li class="slide slide-icon slide-icon--indigo has-sub {{ request()->is('admin/questions*') || request()->is('admin/quizzes*') || request()->is('admin/ai/question-generations*') || request()->is('admin/learning-experiences*') || request()->is('admin/ai-html-quizzes*') ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <li class="slide slide-icon slide-icon--amber has-sub {{ request()->is('admin/notifications*') ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            ...
                            <ul class="slide-menu child1">
                                <li class="slide side-menu__label1">
                                    <a href="javascript:void(0);">الإشعارات</a>
                                </li>
                                <li class="slide {{ request()->is('admin/notifications/inbox') ? 'active' : '' }}">
                                    <a href="{{ route('admin.notifications.inbox') }}" class="side-menu__item {{ request()->is('admin/notifications/inbox') ? 'active' : '' }}">
                                        <span class="side-menu__label">صندوق الإشعارات</span>
                                    </a>
                                </li>
                        ...
                        <li class="slide slide-icon slide-icon--green has-sub {{ request()->is('admin/whatsapp-settings*') || request()->is('admin/whatsapp-messages*') || request()->is('admin/whatsapp-templates*') ? 'open' : '' }}">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                @endcan
                                @can('whats-app-template-list')
                                <li class="slide {{ request()->is('admin/whatsapp-templates*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.whatsapp-templates.index') }}" class="side-menu__item {{ request()->is('admin/whatsapp-templates*') ? 'active' : '' }}">
                        ...
                        <li class="slide slide-icon slide-icon--slate has-sub {{ request()->is('admin/settings*') || request()->is('admin/currencies*') || request()->is('admin/exchange-rates*') || request()->is('admin/sms-*') || request()->is('admin/email-*') || request()->is('admin/app-storage*') || request()->is('admin/storage-disk-mappings*') || request()->is('admin/storage-migration*') || request()->is('admin/backup*') || request()->is('admin/ai*') || request()->is('admin/quiz-attempts/needs-grading*') || request()->is('admin/login-logs*') || request()->is('admin/user-sessions*') || request()->is('admin/stages*') ? 'open' : '' }}">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                {{-- النسخ الاحتياطي --}}
                                @can('settings-manage')
                                <li class="slide has-sub {{ request()->is('admin/backups*') || request()->is('admin/backup-schedules*') ? 'open' : '' }}">
                                    <a href="javascript:void(0);" class="side-menu__item">
                                        <span class="side-menu__label">النسخ الاحتياطي</span>
                                        <i class="fe fe-chevron-right side-menu__angle"></i>
                                    </a>
                                    <ul class="slide-menu child1 settings-sub">
                                        <li class="slide {{ request()->is('admin/backups*') && !request()->is('admin/backup-schedules*') ? 'active' : '' }}">
                                            <a href="{{ route('admin.backups.index') }}" class="side-menu__item {{ request()->is('admin/backups*') && !request()->is('admin/backup-schedules*') ? 'active' : '' }}">
