...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">إضافة إنجاز جديد</h5>
                <nav>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="type" class="form-select" required>
                                        ...
                                        <option value="streak" {{ old('type') == 'streak' ? 'selected' : '' }}>سلسلة</option>
                                    </select>
                                    @error('type')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="points_reward" class="form-control" value="{{ old('points_reward', 0) }}" min="0">
                                    @error('points_reward')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
