                        ...
                        <form action="{{ route('admin.backup-schedules.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="time" class="form-control" id="time" name="time" value="{{ old('time', '02:00') }}" required>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2 flex-wrap">
                                    @foreach($storageDrivers as $id => $driver)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="storage_drivers[]" value="{{ $driver }}" id="storage_{{ $id }}" {{ in_array($driver, old('storage_drivers', ['local'])) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2 flex-wrap">
                                    @foreach($compressionTypes as $key => $label)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="compression_types[]" value="{{ $key }}" id="comp_{{ $key }}" {{ in_array($key, old('compression_types', ['zip'])) ? 'checked' : '' }}>
