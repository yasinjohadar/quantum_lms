<div class="modal fade" id="deleteClass{{ $class->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 rounded-4">
            ...
            <div class="modal-body text-center pt-0 pb-3 px-4">
                <p class="mb-1 text-muted">
                    هل أنت متأكد من حذف الصف التالي؟
                </p>
                <p class="fw-bold mb-1 text-danger" style="font-size:1.15rem;">
                    {{ $class->name }}
                </p>
                <p class="mb-3 text-muted small">
                    سيتم حذف جميع البيانات المرتبطة بهذا الصف (مثل المواد) ولا يمكن التراجع عن هذه العملية.
                </p>
            </div>
