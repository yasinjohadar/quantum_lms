<style>
    ...
    .class-subject-card__free-label {
        font-size: 0.7rem;
        font-weight: 600;
        color: var(--cs-muted);
    }

    .class-subject-card__free .form-check {
        display: flex;
        align-items: center;
        gap: 0.35rem;
    ...
    .class-subject-card__free .form-check-input {
        margin: 0;
        float: none;
        cursor: pointer;
    }

    .class-subject-card__free .form-check-input:disabled {
        cursor: progress;
        opacity: 0.55;
    }

    .class-subject-card__free-state {
        font-size: 0.7rem;
        font-weight: 600;
        color: var(--cs-muted);
        cursor: pointer;
