...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">إضافة سعر صرف جديد</h5>
                <nav>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.exchange-rates.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="rate" name="rate" value="{{ old('rate') }}" step="0.000001" min="0.000001" required>
                                <small class="text-muted">مثال: إذا كان 1 USD = 15000 SYP، أدخل 15000</small>
                                @error('rate')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
