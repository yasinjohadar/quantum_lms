                        ...
                        <form action="{{ route('admin.levels.update', $level) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="level_number" class="form-control" value="{{ old('level_number', $level->level_number) }}" min="1" required>
                                    @error('level_number')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="points_required" class="form-control" value="{{ old('points_required', $level->points_required) }}" min="0" required>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="color" name="color" class="form-control form-control-color" value="{{ old('color', $level->color) }}">
                                    @error('color')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="order" class="form-control" value="{{ old('order', $level->order) }}" min="0">
                                    @error('order')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
