<div class="modal fade" id="deleteLibraryItem{{ $item->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 rounded-4">
            <div class="border-0 text-center pt-4 px-4">
                <div class="d-inline-flex align-items-center justify-content-center mb-3">
                    ...
                    <h5 class="modal-title mb-0 fw-bold">تأكيد حذف العنصر</h5>
                </div>
            ...
            <div class="modal-body text-center pt-0 pb-3 px-4">
                <p class="mb-1 text-muted">هل أنت متأكد من حذف عنصر المكتبة التالي؟</p>
                <p class="fw-bold mb-1 text-danger" style="font-size:1.15rem;">{{ $item->title }}</p>
                <p class="mb-3 text-muted small">سيُحذف الملف المرفق نهائياً ولا يمكن التراجع عن هذه العملية.</p>
            </div>
