...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">سجلات IP: {{ $ip }}</h5>
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.login-logs.index') }}">سجلات الدخول</a></li>
                        <li class="breadcrumb-item active" aria-current="page">سجلات IP: {{ $ip }}</li>
                    </ol>
                </nav>
            </div>
            <div>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="card-title mb-0">معلومات IP Address</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <strong>IP Address:</strong> <code>{{ $ip }}</code>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered text-center mb-0">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            ...
                                            @if($log->user)
                                                <a href="{{ route('admin.login-logs.user', $log->user->id) }}" class="btn btn-sm btn-outline-primary" title="سجلات المستخدم">
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center py-4">لا توجد سجلات لهذا IP</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
