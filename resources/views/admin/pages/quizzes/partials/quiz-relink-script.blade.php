...
document.addEventListener('DOMContentLoaded', function () {
    const stageSelect = document.getElementById('relinkStageSelect');
    const classSelect = document.getElementById('relinkClassSelect');
    const subjectSelect = document.getElementById('relinkSubjectSelect');
    const sectionSelect = document.getElementById('relinkSectionSelect');
    const unitSelect = document.getElementById('relinkUnitSelect');
    const lessonSelect = document.getElementById('relinkLessonSelect');
    const lessonField = document.getElementById('relinkLessonField');
    const scopeRadios = document.querySelectorAll('.quiz-relink-scope');
    ...
    function selectedScope() {
        const checked = document.querySelector('.quiz-relink-scope:checked');
