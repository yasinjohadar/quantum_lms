        ...
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.enrollments.create', ['subject_id' => $subject->id]) }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                                <div>
                                    <h5 class="mb-0 fw-bold">معلومات المادة</h5>
                                    <div class="mt-2">
                                        <span class="badge bg-info-transparent text-info me-2">
                                            {{ $subject->schoolClass?->name ?? 'غير محدد' }}
                                        </span>
                                ...
                                <div class="text-md-end">
                                    ...
                                    <small class="text-muted">إجمالي الطلاب المنضمين</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                            ...
                            <form method="GET" action="{{ route('admin.subjects.enrolled-students', $subject->id) }}"
                                ...
                                <a href="{{ route('admin.subjects.enrolled-students', $subject->id) }}" class="btn btn-outline-danger btn-sm">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center py-5">
                                                ...
                                                <p class="text-muted">لا يوجد طلاب منضمين لهذه المادة</p>
                                                <a href="{{ route('admin.enrollments.create', ['subject_id' => $subject->id]) }}" class="btn btn-primary btn-sm">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <p class="mb-3">هل أنت متأكد من إلغاء انضمام الطالب <strong>{{ $enrollment->user->name }}</strong> لمادة <strong>{{ $subject->name }}</strong>؟</p>
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <form action="{{ route('admin.enrollments.destroy', $enrollment->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <input type="hidden" name="redirect_to" value="{{ route('admin.subjects.enrolled-students', $subject->id) }}">
