...
@section('content')
    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.supervisors.assignments.update', $supervisor->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-xl-6">
                        <div class="card" id="classSection">
                            <div class="card-header">
                                ...
                                <small class="text-muted">تحديد الصفوف التي يمكن للمشرف الوصول إليها (جميع المواد في الصف)</small>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-xl-6">
                        <div class="card" id="subjectSection">
                            <div class="card-header">
                                ...
                                <small class="text-muted">تحديد المواد التي يمكن للمشرف الوصول إليها مباشرة</small>
                            </div>
                            <div class="card-body">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-3">معلومات المشرف</h6>
                                <div class="row">
                                    <div class="col-md-4">
                                        <p class="mb-1"><strong>الاسم:</strong> {{ $supervisor->name }}</p>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="mb-1"><strong>البريد الإلكتروني:</strong> {{ $supervisor->email }}</p>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="mb-1">
