...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .certificate { width: 100%; max-width: 1200px; margin: 0 auto; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 60px; text-align: center; box-shadow: 0 0 30px rgba(0,0,0,0.1); color: #fff; }
