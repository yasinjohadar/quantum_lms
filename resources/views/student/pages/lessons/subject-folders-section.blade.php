                ...
                <div class="mb-4">
                    ...
                    <div class="section-lessons-list">
                        @foreach($directLessons as $lesson)
                            ...
                            @endphp
                            <div class="accordion-item border rounded mb-2 overflow-hidden shadow-sm" id="section-lesson-heading-{{ $lesson->id }}">
                                <div class="d-flex align-items-stretch bg-light">
                                    <button type="button"
                                        class="section-lesson-video-btn flex-grow-1 d-flex align-items-center flex-wrap gap-2 py-3 px-3 border-0 bg-transparent text-start text-primary fw-medium"
