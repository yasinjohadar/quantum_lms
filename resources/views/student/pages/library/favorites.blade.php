...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">مفضلتي</h5>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form method="GET" action="{{ route('student.library.favorites') }}" class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    ...
                                    @if(request('search'))
                                        <span class="badge bg-primary">
                                            بحث: {{ request('search') }}
                                            <a href="{{ route('student.library.favorites', array_merge(request()->except('search'), ['page' => 1])) }}" class="text-white ms-1" style="text-decoration: none;">×</a>
                                        </span>
                                    @endif
                                    ...
                                    @if(request('category_id'))
                                        ...
                                        @if($selectedCategory)
                                            <span class="badge bg-info">
                                                ...
                                                <a href="{{ route('student.library.favorites', array_merge(request()->except('category_id'), ['page' => 1])) }}" class="text-white ms-1" style="text-decoration: none;">×</a>
                                            </span>
                                        @endif
                                    @endif
                                    ...
                                    @if(request('type'))
                                        <span class="badge bg-secondary">
                                            ...
                                            <a href="{{ route('student.library.favorites', array_merge(request()->except('type'), ['page' => 1])) }}" class="text-white ms-1" style="text-decoration: none;">×</a>
                                        </span>
                                    @endif
                                    
                                    <a href="{{ route('student.library.favorites') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="col-12">
                    <div class="alert alert-info text-center">
                        ...
                        <a href="{{ route('student.library.index') }}" class="btn btn-primary mt-2">
                            <i class="fas fa-book me-1"></i> تصفح المكتبة
                        </a>
                    </div>
                </div>
            @endforelse
